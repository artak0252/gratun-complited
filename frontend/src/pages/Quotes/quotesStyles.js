// Tailwind class-string map replacing Quotes.module.css
const styles = {
  ...
  quotesGrid: "flex flex-col gap-[30px] max-w-[1100px] mx-auto",
  quoteCard: "relative bg-[#E4E8F0] rounded-3xl px-[6%] py-10 flex items-center gap-10 box-border transition-[0.3s] hover:shadow-[0_16px_32px_rgba(20,49,92,0.08)] max-[700px]:flex-col max-[700px]:text-center max-[700px]:gap-5 max-[700px]:py-[30px]",
  imageSide: "flex-none",
  authorPhoto: "w-[120px] h-[120px] rounded-full object-cover border-4 border-white shadow-[0_0_0_3px_#14315C] block",
  authorPhotoFallback: "w-[120px] h-[120px] rounded-full bg-white border-4 border-white shadow-[0_0_0_3px_#14315C] flex items-center justify-center text-[44px] text-[#14315C]",
  textSide: "flex-[1_1_500px] max-w-[780px] relative",
  quoteMark: "font-['Playfair_Display','Noto_Serif_Armenian',serif] text-[56px] leading-[0] text-[#d35400] block mb-1.5",
  quoteText: "font-['Playfair_Display','Noto_Serif_Armenian',serif] italic font-semibold text-xl text-[#14315C] leading-[1.55] mb-3.5 max-[700px]:text-[18px]",
  author: "font-[Poppins,Noto_Sans_Armenian,sans-serif] text-[15px] font-semibold text-[#525252] tracking-[0.5px]",
  adminQuoteActions: "absolute top-4 right-4 flex gap-2 z-[2]",
