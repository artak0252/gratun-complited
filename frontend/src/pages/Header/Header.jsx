    ...
    <header className="relative z-[1000] w-full bg-[#E4E8F0] border-b-[5px] border-white px-10 py-2.5 box-border max-lg:px-6 max-lg:py-4 max-[480px]:px-4 max-[480px]:py-3.5">
      <div className="relative flex items-center gap-7 max-w-[1400px] mx-auto max-md:flex-wrap">
        ...
        <div className="flex items-center flex-1 gap-5 max-md:gap-4 max-[480px]:gap-3">
          <nav
            className={`flex items-baseline justify-center flex-1 gap-9 max-lg:gap-5 max-md:flex-col max-md:items-start max-md:gap-0 max-md:absolute max-md:top-full max-md:left-0 max-md:right-0 max-md:bg-[#E4E8F0] max-md:border-t max-md:border-white max-md:shadow-[0_8px_16px_rgba(58,50,44,0.08)] max-md:overflow-hidden max-md:transition-[max-height,opacity] max-md:duration-300 max-md:ease-in-out ${isOpen ? 'max-md:max-h-[500px] max-md:opacity-100 max-md:visible' : 'max-md:max-h-0 max-md:opacity-0 max-md:invisible'}`}
          >
            <Link to="/" className="text-lg font-medium tracking-[0.3px] text-[#3A322C] no-underline whitespace-nowrap transition-colors duration-200 hover:text-[#6B3245] max-lg:text-sm max-md:w-full max-md:px-6 max-md:py-3.5 max-md:border-b max-md:border-white max-md:text-base" onClick={() => setIsOpen(false)}>Գլխավոր</Link>
            <Link to="/shop" className="text-lg font-medium tracking-[0.3px] text-[#3A322C] no-underline whitespace-nowrap transition-colors duration-200 hover:text-[#6B3245] max-lg:text-sm max-md:w-full max-md:px-6 max-md:py-3.5 max-md:border-b max-md:border-white max-md:text-base" onClick={() => setIsOpen(false)}>Գրքեր</Link>
            <Link to="/blog" className="text-lg font-medium tracking-[0.3px] text-[#3A322C] no-underline whitespace-nowrap transition-colors duration-200 hover:text-[#6B3245] max-lg:text-sm max-md:w-full max-md:px-6 max-md:py-3.5 max-md:border-b max-md:border-white max-md:text-base" onClick={() => setIsOpen(false)}>Բլոգ</Link>
            <Link
              to="/quotes"
              className="text-lg font-medium tracking-[0.3px] text-[#3A322C] no-underline whitespace-nowrap transition-colors duration-200 hover:text-[#6B3245] max-lg:text-sm max-md:w-full max-md:px-6 max-md:py-3.5 max-md:border-b max-md:border-white max-md:text-base flex flex-col items-center leading-[1.15] text-center max-md:flex-row max-md:items-start max-md:text-left"
