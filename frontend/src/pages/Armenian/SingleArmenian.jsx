...
const SingleArmenian = () => {
          ...
          useEffect(() => {
                    const fetchItem = async () => {
                              ...
                              try {
                                        const response = await axios.get(`${API_URL}/armenian/${id}`);
                    ...
                    <div className="px-[8%] py-[70px] bg-white min-h-screen max-[900px]:px-[6%] max-[900px]:py-[50px] max-[480px]:px-[5%] max-[480px]:py-[35px]">
                              <Seo
                                        ...
                                        jsonLd={{
                                                  ...
                                                  mainEntityOfPage: `${SITE_URL}/armenian/${item._id}`,
                                        }}
                              />
                              <Link to="/armenian" className="inline-block mb-10 text-[#14315C] no-underline font-semibold font-[Noto_Sans_Armenian,Poppins,sans-serif] hover:text-[#d35400] max-[480px]:mb-[25px]">← Հետ դեպի Հայ և հայկական</Link>
