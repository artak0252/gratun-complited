// Tailwind class-string map "Հայ և հայկական" բաժնի համար.
// Palette-ը նույնն է, ինչ Literature/Quotes/ThematicBooks էջերինը (navy #14315C +
// terracotta #d35400), որպեսզի ամբողջ կայքում մնա միասնական տեսք։
const styles = {
          ...
          // --- Նախադիտման («preview») էկրանի classes ---
          // flex-wrap + justify-center ինքնաշխատ սիմետրիկ է դասավորում ցանկացած
          // քանակի քարտ (2, 3, կամ բոլոր 7-ը)՝ առանց հատուկ grid-column հաշվարկների
          previewGrid: "flex flex-wrap justify-center gap-[25px] max-w-[1200px] mx-auto",
          previewCard: "w-[260px] bg-white rounded-3xl border border-[#f5f5f5] overflow-hidden cursor-pointer transition-[0.35s] text-left hover:-translate-y-1.5 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] max-[480px]:w-full",
          previewCardImg: "w-full h-[170px] object-cover",
          previewCardBody: "p-5",
          previewCardCategory: "inline-block font-[Noto_Sans_Armenian,Poppins,sans-serif] text-[11px] uppercase tracking-[0.5px] font-semibold text-[#d35400] mb-2",
          previewCardTitle: "font-['Playfair_Display','Noto_Serif_Armenian',serif] text-lg font-semibold text-[#14315C] mb-1.5 leading-[1.3]",
          previewCardExcerpt: "font-[Noto_Sans_Armenian,Poppins,sans-serif] text-[13.5px] leading-[1.6] text-[#6b7280] [display:-webkit-box] [-webkit-line-clamp:3] [-webkit-box-orient:vertical] overflow-hidden",
          previewEmpty: "text-center text-[#9ca3af] text-base py-[60px] max-w-[500px] mx-auto",
          backToPreviewBtn: "inline-flex items-center gap-1.5 mb-6 text-[#14315C] no-underline font-semibold font-[Noto_Sans_Armenian,Poppins,sans-serif] bg-transparent border-none cursor-pointer p-0 hover:text-[#d35400]",
};
